<div class="index-card-image-grid-outer index-grid-desktop">
    <section class="l-wrapper xl index-card-image-grid">
        ...
        <div class="index-grid-container">
            ...
            </div><!--/.index-grid-col-1-->


            <div class="index-grid-col-2">
            ...
            </div><!--/.index-grid-col-2-->


            <div class="index-grid-col-3">
